...
$site_title = apply_filters( 'mps_site_title', $title );
...
$site_description = apply_filters( 'mps_site_description', $description );
...
$logo = apply_filters( 'mps_logo', $output );

/**
 * Output header content.
 */
do_action( 'mps_before_header_content' ); ?>
...
<?php do_action( 'mps_after_header_content' );